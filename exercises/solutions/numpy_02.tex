\begin{enumerate}
  ...
  \item \lstinline!np.linspace(0,5,6)!  
...
lösen. Zu beachten ist hierbei lediglich, dass \lstinline!array.empty()!,
\lstinline!array.ones()! und \lstinline!array.zeros()! standardmäßig Arrays mit
