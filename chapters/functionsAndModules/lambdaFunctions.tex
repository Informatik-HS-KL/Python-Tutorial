...
Wie 
%\ref{lambdaFunctions:lst:syntaxLambda} 
zu sehen ist, werden Lambda-Funktionen mit dem Schlüsselwort \lstinline$lambda$ definiert --- und nicht mit \lstinline$def$.
