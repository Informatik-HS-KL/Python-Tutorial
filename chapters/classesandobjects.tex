...
Dieses Kapitel setzt voraus, dass die Leser mit dem Konzept der Objektorientierung
vertraut sind.
...
\section{Klassen und Objekte erstellen}
...
class Kreis:
    radius = 1
\end{lstlisting}
Mithilfe der erstellten Klasse können nun verschiedene Objekte erstellt werden, die die Variablen und Methoden der Klasse beinhalten.
...
\section{Die \textunderscore \textunderscore init\textunderscore \textunderscore () Methode}
...
\section{Die \textunderscore \textunderscore del\textunderscore \textunderscore () Methode}
...
kreis2.getRadius()
\end{lstlisting}
Fehlermeldung beim Ausführen dieses Programmcodes:
\begin{lstlisting}[language=Python,
...
<bound method B.__del__ of <__main__.B object 
                    at 0x7f6813e3a898>>
...
...
#Klassenattribute sind auch über die 
#Klasseninstanz erreichbar
...
default
\end{lstlisting}
Mit Hilfe der Funktion \lstinline{standardType()}, die an die Klasse A gebunden ist, kann zur Erzeugung des Objektes ein Parameter Wert für die \lstinline{__init__} Methode festgelegt werden.
